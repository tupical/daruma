//! `daruma-ai-infra` — provider-neutral AI infrastructure.
//!
//! This crate holds the parts of the AI layer that do **not** depend on
//! Daruma's task operations: the OpenAI Responses API client, runtime
...
//!
//! `daruma-ai-infra` is the **primitive** layer — shared infrastructure
...
//! - Errors propagate as [`daruma_shared::CoreError`] (via [`AiError`]).
